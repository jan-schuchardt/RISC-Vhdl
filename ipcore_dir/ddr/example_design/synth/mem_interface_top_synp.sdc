...
define_attribute          {v:work.ddr_addr_gen_0} syn_hier {hard}
...
define_attribute          {v:work.ddr_cmd_fsm_0} syn_hier {hard}
define_attribute          {v:work.ddr_cmp_data_0} syn_hier {hard}
define_attribute          {v:work.ddr_controller_0} syn_hier {hard}
define_attribute          {v:work.ddr_controller_iobs_0} syn_hier {hard}
define_attribute          {v:work.ddr_data_gen_0} syn_hier {hard}
...
define_attribute          {v:work.ddr_main_0} syn_hier {hard}
...
define_attribute          {v:work.ddr_test_bench_0} syn_hier {hard}

...
\begin{figure}[H]
	...
	\caption[Interface ASCII-Unit]{Das Interface der ASCII-Unit}
	\label{fig:interface}
\end{figure}
...
\begin{figure}[H]
	...
	\caption[\"Ubersicht ASCII-Unit]{\"Ubersicht: Beginn bei x- bzw. y-Koordinate; Verrechnung dieser zur Adresse f\"ur CHARRAM; dann Durchleiten in CHARMAP; anschlie\ss{}end Berechnung des Pixels; letztendlich Zur\"ucksenden an VGA-Unit}
	\label{fig:overview}
\end{figure}

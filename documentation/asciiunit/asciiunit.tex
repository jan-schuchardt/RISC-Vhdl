...
\begin{figure}[H]
	...
	\caption{\"Ubersicht: Beginn bei X- bzw. Y-Koordinate, Verrechnung dieser zur Adresse f\"ur CHARRAM, dann Durchleiten in CHARMAP, anschlie\ss{}end Berechnung des Pixels}
	\label{fig:pixels}
\end{figure}

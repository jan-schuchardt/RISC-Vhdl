...
\begin{table}[H]
	...
	\begin{tabular}{| l | l | l | l |}
		...
		0x1 & SDRAM & $2^{16}$\footnotemark{} & DDR2-SDRAM\footnote{Von 512 MBit verf\"ugbaren Speicherplatz macht der genutzte Controller nur $2^{16}$ Bytes zug\"anglich} \\ \hline

...
\Statemachine{
\Point{s}{}
\State{s1}{right =20pt of s}{ALU: R[0] := \Ipart{rs1} + \Ipart{offset}}
...
\State{s5}{right =30pt of s4}{MMU: Speichere \(width\) Bytes aus \Vhdl{alu\_data\_in} an zwischenspeicherte Adresse}

...
verwaltet als diese den Program-Counter~(PC) und
das Instruction-Register~(IR). Es
interpretiert die Befehle und \"uberwacht ihre Ausf\"uhrung durch ALU und MMU, dabei
lag der Fokus mehr auf Robustheit und weniger auf Aspekten der
Performanz.
...
allerdings im Projektverlauf ein nachteiliger Charakter dieser Entscheidung gezeigt, da die Ausf\"uhrungsdauer des Befehls wird in der Praxis

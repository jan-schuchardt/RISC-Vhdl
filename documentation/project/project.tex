...
Als Mindestanforderung sollte ein Prozessor mit Kompatibilit\"at zur \Externalname{RV32I Base Integer Instruction Set} implementiert werden. Ausgenommen davon sind die Befehle FENCE, FENCE.I, SCALL und SBREAK, da keine Hardwareunterst\"utzung f\"ur den Multitaskingbetrieb ben\"otigt wird.
...
\begin{figure}[H]
	...
	\caption{Der Xilinx \Externalname{ISE Project Navigator}}
	\label{fig:tool}
\end{figure}
